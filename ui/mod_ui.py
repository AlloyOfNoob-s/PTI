...
"border-color: rgb(152, 255, 255);")
        ...
        self.voice = QtWidgets.QPushButton(parent=self.widget_2)
        self.voice.setObjectName("voice")
        self.verticalLayout_3.addWidget(self.voice)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "IMPORTANT: this thing wont install modloader or the mod that the mod you\'re installing need"))
